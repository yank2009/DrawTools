    ...
    public class DocManager
    {
        ...
        public bool CloseDocument()
        {
            ...
            frmOwner.Invoke(new Action(() =>
            {
                ...
                switch (res)
                {
                    case DialogResult.Yes: result = SaveDocument(SaveType.Save); break;
                    case DialogResult.No: result = true; break;
                    case DialogResult.Cancel: result = false; break;
                    default: Debug.Assert(false); result = false; break;
                }
            }));
            return result;
        }
